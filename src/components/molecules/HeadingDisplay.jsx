...
<div className="text-center">
        <div className="bg-gradient-to-r from-surface to-gray-800 rounded-xl p-4 sm:p-6 border-2 border-primary">
...
{/* Detailed Readings */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
        <div className="bg-surface rounded-lg p-3 sm:p-4 border border-primary/30">
